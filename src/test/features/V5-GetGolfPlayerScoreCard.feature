...
Feature: V5 retrieve the yearly Season Golf event schedule
  Scenario Outline: User calls web service to get yearly Season Golf event schedule
	Given a Golf Player Score Card for an event for V5
	When a user retrieves the current tour V5 european-tour Golf Player <playerId> Score Card for a leaderboard of an event <eventId>
